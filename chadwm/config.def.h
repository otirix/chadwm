...
static const char *fonts[]          = {"Inter:style:medium:size=10" ,"Hack Nerd Font Mono:style:medium:size=10" };
...
static const Key keys[] = {
    ...
    {MODKEY, XK_p, spawn,
        SHCMD("maim --select | swappy -f - -o /tmp/screenshot.png && xclip -selection clipboard -t image/png -i /tmp/screenshot.png")},
    {MODKEY|ControlMask, XK_p, spawn,
        SHCMD("maim | swappy -f - -o /tmp/screenshot.png && xclip -selection clipboard -t image/png -i /tmp/screenshot.png")},

    { MODKEY,                           XK_space,   spawn,          SHCMD("rofi -show drun") },
    { MODKEY,                           XK_Return,  spawn,            SHCMD("kitty")},

    // browser
    { WINKEY,                           XK_f,       spawn,          SHCMD("google-chrome-stable")},

    // toggle stuff
    { MODKEY,                           XK_b,       togglebar,      {0} },
    { MODKEY|ControlMask,               XK_t,       togglegaps,     {0} },
    { MODKEY|ShiftMask,                 XK_space,   togglefloating, {0} },
    { WINKEY,                           XK_Return,  togglefullscr,  {0} },
